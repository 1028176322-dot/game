    ...
    execute: function () {
      ...
      _export("SaveService", SaveService = class SaveService {
        ...
        loadProfile() {
          ...
          let profile = this._migrator.loadProfile(defaults); // Merge newly-added default unlocks into existing profiles so old saves
          ...
          const result = (_crd && SaveValidator === void 0 ? (_reportPossibleCrUseOfSaveValidator({
            error: Error()
          ...
          if (!result.ok) {
            ...
            const repair = (_crd && SaveValidator === void 0 ? (_reportPossibleCrUseOfSaveValidator({
              error: Error()
            ...
            const retry = (_crd && SaveValidator === void 0 ? (_reportPossibleCrUseOfSaveValidator({
              error: Error()
            }), SaveValidator) : SaveValidator).validateProfile(profile);
        ...
        saveProfile(profile) {
          ...
          const check = (_crd && SaveValidator === void 0 ? (_reportPossibleCrUseOfSaveValidator({
            error: Error()
        ...
        loadRun() {
          const result = this._storage.getJson((_crd && SAVE_KEYS === void 0 ? (_reportPossibleCrUseOfSAVE_KEYS({
            error: Error()
        ...
        exportDebugSave() {
          ...
          for (const key of Object.values(_crd && SAVE_KEYS === void 0 ? (_reportPossibleCrUseOfSAVE_KEYS({
            error: Error()
          }), SAVE_KEYS) : SAVE_KEYS)) {
