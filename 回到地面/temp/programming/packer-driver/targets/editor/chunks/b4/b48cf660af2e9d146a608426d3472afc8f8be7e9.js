    ...
    execute: function () {
      ...
      _export("GameBootstrap", GameBootstrap = (_dec = ccclass('GameBootstrap'), _dec2 = property(Label), _dec(_class = (_class2 = (_class3 = class GameBootstrap extends Component {
        ...
        _wireInfra() {
          ...
          const runtimeState = new (_crd && RuntimeState === void 0 ? (_reportPossibleCrUseOfRuntimeState({
            error: Error()
          ...
          const debugPanel = new (_crd && DebugPanel === void 0 ? (_reportPossibleCrUseOfDebugPanel({
            error: Error()
          ...
          const perfSampler = new (_crd && PerfSampler === void 0 ? (_reportPossibleCrUseOfPerfSampler({
            error: Error()
          ...
          const assetCache = new (_crd && AssetCache === void 0 ? (_reportPossibleCrUseOfAssetCache({
            error: Error()
          ...
          const cameraBrain = new (_crd && CameraBrain === void 0 ? (_reportPossibleCrUseOfCameraBrain({
            error: Error()
          ...
          const lighting = new (_crd && LightingService === void 0 ? (_reportPossibleCrUseOfLightingService({
            error: Error()
          ...
          const collision = new (_crd && PhysicsCollisionImpl === void 0 ? (_reportPossibleCrUseOfPhysicsCollisionImpl({
            error: Error()
          ...
          const targetSelector = new (_crd && TargetSelector === void 0 ? (_reportPossibleCrUseOfTargetSelector({
            error: Error()
          ...
          const hitResolver = new (_crd && HitResolver === void 0 ? (_reportPossibleCrUseOfHitResolver({
            error: Error()
          ...
          const damageResolver = new (_crd && DamageResolver === void 0 ? (_reportPossibleCrUseOfDamageResolver({
            error: Error()
          ...
          const skillGraph = new (_crd && SkillGraph === void 0 ? (_reportPossibleCrUseOfSkillGraph({
            error: Error()
          ...
          const skillExecutor = new (_crd && SkillExecutor === void 0 ? (_reportPossibleCrUseOfSkillExecutor({
            error: Error()
          ...
          const roomData = new (_crd && RoomBuilder === void 0 ? (_reportPossibleCrUseOfRoomBuilder({
            error: Error()
          }), RoomBuilder) : RoomBuilder)().build(layout.rooms[0]);
          const navGrid = new (_crd && NavigationGrid === void 0 ? (_reportPossibleCrUseOfNavigationGrid({
            error: Error()
          ...
          const saveBackend = new (_crd && MemorySaveBackend === void 0 ? (_reportPossibleCrUseOfMemorySaveBackend({
            error: Error()
          }), MemorySaveBackend) : MemorySaveBackend)();
          const saveManager = new (_crd && SaveManagerImpl === void 0 ? (_reportPossibleCrUseOfSaveManagerImpl({
            error: Error()
          ...
          const replayRecorder = new (_crd && ReplayRecorder === void 0 ? (_reportPossibleCrUseOfReplayRecorder({
            error: Error()
          ...
          const audioSystem = new (_crd && AudioSystem === void 0 ? (_reportPossibleCrUseOfAudioSystem({
            error: Error()
          ...
          const animSM = new (_crd && AnimationStateMachine === void 0 ? (_reportPossibleCrUseOfAnimationStateMachine({
            error: Error()
          ...
          const eventBus = new (_crd && EventBusManager === void 0 ? (_reportPossibleCrUseOfEventBusManager({
            error: Error()
          ...
          const entityManager = new (_crd && EntityManager === void 0 ? (_reportPossibleCrUseOfEntityManager({
            error: Error()
          ...
          const movementC = new (_crd && MovementComponent === void 0 ? (_reportPossibleCrUseOfMovementComponent({
            error: Error()
          ...
          const animC = new (_crd && AnimationComponent === void 0 ? (_reportPossibleCrUseOfAnimationComponent({
            error: Error()
          ...
          const combatC = new (_crd && CombatComponent === void 0 ? (_reportPossibleCrUseOfCombatComponent({
            error: Error()
          ...
          const statC = new (_crd && StatComponent === void 0 ? (_reportPossibleCrUseOfStatComponent({
            error: Error()
          ...
          const targetC = new (_crd && TargetComponent === void 0 ? (_reportPossibleCrUseOfTargetComponent({
            error: Error()
          ...
          const interactionC = new (_crd && InteractionComponent === void 0 ? (_reportPossibleCrUseOfInteractionComponent({
            error: Error()
          ...
          const combatSystem = new (_crd && CombatSystem === void 0 ? (_reportPossibleCrUseOfCombatSystem({
            error: Error()
          ...
          const logger = this._ctx.get(_crd && ILogger === void 0 ? (_reportPossibleCrUseOfILogger({
            error: Error()
