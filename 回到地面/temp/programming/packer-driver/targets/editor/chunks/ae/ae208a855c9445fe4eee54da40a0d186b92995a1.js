    ...
    execute: function () {
      ...
      _export("UpgradeManager", UpgradeManager = (_dec = ccclass('UpgradeManager'), _dec(_class = class UpgradeManager extends Component {
        ...
        _onDoubleStrike(result) {
          ...
          const secondDmg = Math.max((_crd && GameConfig === void 0 ? (_reportPossibleCrUseOfGameConfig({
            error: Error()
        ...
        _onWhirlwind(result) {
          ...
          const aoeDmg = Math.max((_crd && GameConfig === void 0 ? (_reportPossibleCrUseOfGameConfig({
            error: Error()
        ...
        _onChainLightning(result) {
          ...
          const chainDmg = Math.max((_crd && GameConfig === void 0 ? (_reportPossibleCrUseOfGameConfig({
            error: Error()
        ...
        _equipRelicSkill(id, name, cd, isRelic, castFn) {
          ...
          const slots = [(_crd && SkillSlot === void 0 ? (_reportPossibleCrUseOfSkillSlot({
            error: Error()
