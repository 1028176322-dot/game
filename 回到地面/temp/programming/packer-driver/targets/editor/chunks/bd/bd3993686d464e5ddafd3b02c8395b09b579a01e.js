System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  function devicePixelRatio() {
    ...
    const dpr = (_view$getDevicePixelR = view.getDevicePixelRatio == null ? void 0 : view.getDevicePixelRatio()) != null ? _view$getDevicePixelR : 1;
    ...
    execute: function () {
      ...
      _export("PreviewSurface", PreviewSurface = class PreviewSurface {
        ...
        acquire(slotNode, opts) {
          ...
          const ownerId = (_opts$ownerId = opts == null ? void 0 : opts.ownerId) != null ? _opts$ownerId : '__default__';
          ...
          const handle = new SurfaceHandleImpl(surfaceNode, modelRoot, layer, camera, rt, rigNode, self => this._releaseHandle(self, ownerId));
