    ...
    execute: function () {
      ...
      _export("AIController", AIController = class AIController {
        ...
        update(_dt) {
          ...
          const decision = this._active.decide(self, perception); // Combat layering: emit commands through the owner sink; never touch state directly.
          ...
          const anim = this._ctx.get(_crd && IAnimationControllerToken === void 0 ? (_reportPossibleCrUseOfIAnimationControllerToken({
            error: Error()
          ...
          const dist = perception.targetAlive ? manhattan(self.gridX, self.gridY, perception.targetX, perception.targetY) : -1;
          this._lastDebug = {
