    ...
    execute: function () {
      ...
      _export("CharacterPanel", CharacterPanel = (_dec = ccclass('CharacterPanel'), _dec2 = property(Node), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Label), _dec6 = property(Label), _dec7 = property(Label), _dec8 = property(Node), _dec9 = property(Button), _dec(_class = (_class2 = class CharacterPanel extends Component {
        ...
        async _refresh() {
          ...
          const className = slotInfo ? (_crd && T === void 0 ? (_reportPossibleCrUseOfT({
            error: Error()
          ...
          if (this.currentInfo) {
            this.currentInfo.string = (_crd && T === void 0 ? (_reportPossibleCrUseOfT({
              error: Error()
            }), T) : T)('ui.charInfo', {
          ...
          if (this.currentStats) {
            this.currentStats.string = (_crd && T === void 0 ? (_reportPossibleCrUseOfT({
              error: Error()
            }), T) : T)('ui.charStats', {
          ...
          this._buildSlots(pdm, selectedId); // 3D character preview in PreviewSlot (T3). Re-acquire every refresh so
        ...
        _ensurePreviewSlot() {
          ...
          const contentRoot = (_ref = (_this$panelRoot$getCh = (_this$panelRoot = this.panelRoot) == null ? void 0 : _this$panelRoot.getChildByPath('PanelFrame/ContentRoot')) != null ? _this$panelRoot$getCh : (_this$panelRoot2 = this.panelRoot) == null ? void 0 : _this$panelRoot2.getChildByName('ContentRoot')) != null ? _ref : this.panelRoot;
        ...
        _buildSlots(pdm, selectedId) {
          ...
          CHAR_SLOTS.forEach(slot => {
            ...
            const className = (_crd && T === void 0 ? (_reportPossibleCrUseOfT({
              error: Error()
            }), T) : T)(slot.classKey);
        ...
        _addRowButton(parent, text, x, y, cb, disabled = false) {
