      ...
      _export("CameraBrain", CameraBrain = class CameraBrain {
        ...
        initialize(_ctx) {
          ...
          for (const key of keys) {
            const raw = this._db.getCamera(key);

            this._params[key] = raw ? { ...defaultParams(),
              ...raw
            } : defaultParams();
          }
        ...
        lateUpdate(dt) {
          ...
          const p = (_this$_params$MODE_KE = this._params[MODE_KEY[this._mode]]) != null ? _this$_params$MODE_KE : defaultParams();
