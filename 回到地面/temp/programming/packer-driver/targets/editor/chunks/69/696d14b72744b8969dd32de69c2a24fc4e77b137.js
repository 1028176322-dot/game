    ...
    execute: function () {
      ...
      _export("EcsEntityFactory", EcsEntityFactory = class EcsEntityFactory {
        static build(ctx, opts) {
          ...
          const stat = new (_crd && StatComponent === void 0 ? (_reportPossibleCrUseOfStatComponent({
            error: Error()
          }), StatComponent) : StatComponent)();
          stat.initialize(opts.baseHP, opts.baseATK, opts.baseDEF, opts.baseSpeed);
          const movement = new (_crd && MovementComponent === void 0 ? (_reportPossibleCrUseOfMovementComponent({
            error: Error()
          }), MovementComponent) : MovementComponent)();
          movement.initialize(ctx, opts.startX, opts.startY);
          const anim = new (_crd && AnimationComponent === void 0 ? (_reportPossibleCrUseOfAnimationComponent({
            error: Error()
          }), AnimationComponent) : AnimationComponent)(opts.clipMap);
          anim.initialize(ctx);
          const combat = new (_crd && CombatComponent === void 0 ? (_reportPossibleCrUseOfCombatComponent({
            error: Error()
          }), CombatComponent) : CombatComponent)();
          combat.initialize(opts.id, opts.dispatch);
          const target = new (_crd && TargetComponent === void 0 ? (_reportPossibleCrUseOfTargetComponent({
            error: Error()
          }), TargetComponent) : TargetComponent)();
          target.initialize(opts.startX, opts.startY);
          const interaction = new (_crd && InteractionComponent === void 0 ? (_reportPossibleCrUseOfInteractionComponent({
            error: Error()
          ...
          const damageable = new (_crd && StatDamageable === void 0 ? (_reportPossibleCrUseOfStatDamageable({
            error: Error()
