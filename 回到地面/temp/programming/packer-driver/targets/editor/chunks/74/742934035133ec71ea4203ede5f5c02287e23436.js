    ...
    execute: function () {
      ...
      _export("WeaponAttachService", WeaponAttachService = {
        resolveSocket(root, name, fallback) {
          ...
          const found = (_crd && resolveSocketByName === void 0 ? (_reportPossibleCrUseOfresolveSocketByName({
            error: Error()
        ...
        attach(socket, weaponPrefab) {
          ...
          const weapon = instantiate(weaponPrefab); // Reset the weapon root's local transform so it spawns exactly at the socket.
