    ...
    execute: function () {
      ...
      _export("NodeRef", NodeRef = class NodeRef {
        ...
        static component(ref, type, fallbackRoot, fallbackPath) {
          ...
          const node = (_this$node = this.node(ref)) != null ? _this$node : this.find(fallbackRoot, fallbackPath);
        ...
        static childComponent(ref, type, fallbackRoot, fallbackPath) {
          ...
          const node = (_this$node2 = this.node(ref)) != null ? _this$node2 : this.find(fallbackRoot, fallbackPath);
