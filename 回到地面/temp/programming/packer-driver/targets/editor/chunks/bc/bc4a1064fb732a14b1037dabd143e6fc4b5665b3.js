      ...
      _export("GridManager", GridManager = (_dec = ccclass('GridManager'), _dec2 = property(Prefab), _dec(_class = (_class2 = class GridManager extends Component {
        ...
        _renderTile(cell) {
          ...
          if (this.tilePrefab) {
            ...
            const terrainName = (_cell$terrain$toLower = (_cell$terrain = (_crd && TerrainType === void 0 ? (_reportPossibleCrUseOfTerrainType({
              error: Error()
          ...
          const transform = (_tileNode = tileNode) == null ? void 0 : _tileNode.getComponent(UITransform);
        ...
        _getDefaultTerrain(x, y) {
          ...
          const gridRng = (_crd && RunRng === void 0 ? (_reportPossibleCrUseOfRunRng({
            error: Error()
