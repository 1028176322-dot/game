    ...
    execute: function () {
      ...
      _export("CreatePanel", CreatePanel = (_dec = ccclass('CreatePanel'), _dec2 = property(Node), _dec(_class = (_class2 = class CreatePanel extends Component {
        ...
        open(_params) {
          ...
          const defaultId = CHAR_OPTIONS.some(c => c.id === selected) && pdm.isCharacterUnlocked(selected) ? selected : (_CHAR_OPTIONS$find$id = (_CHAR_OPTIONS$find = CHAR_OPTIONS.find(c => pdm.isCharacterUnlocked(c.id))) == null ? void 0 : _CHAR_OPTIONS$find.id) != null ? _CHAR_OPTIONS$find$id : 'warrior';
        ...
        _prepareIntegratedBackground() {
          const root = this.panelRoot;
          const frame = root == null ? void 0 : root.getChildByName('PanelFrame');
          const mask = root == null ? void 0 : root.getChildByName('DimMask'); // Only disable the background sprites, never deactivate the nodes.
          // PanelFrame carries the ContentRoot subtree with all buttons/inputs.

          const frameSprite = frame == null ? void 0 : frame.getComponent(Sprite);
          if (frameSprite) frameSprite.enabled = false;
          const maskSprite = mask == null ? void 0 : mask.getComponent(Sprite);
        ...
        _layoutAll() {
          ...
          const pw = (_rootTrans$width = rootTrans == null ? void 0 : rootTrans.width) != null ? _rootTrans$width : 1280;
          const ph = (_rootTrans$height = rootTrans == null ? void 0 : rootTrans.height) != null ? _rootTrans$height : 720; // SelectView: centered, top zone starts at ph/2 - padding
        ...
        _setPhase(phase) {
          ...
          const skipLabel = (_this$_skipBtn2 = this._skipBtn) == null ? void 0 : _this$_skipBtn2.getComponentInChildren(Label);
          ...
          const confirmLabel = (_this$_confirmBtn2 = this._confirmBtn) == null ? void 0 : _this$_confirmBtn2.getComponentInChildren(Label);
        ...
        async _updateModelDisplay(id) {
          var _this$_previewHandle3;

          if (!this._modelDisplay) return; // Generation token guards against stale-handle leaks: if a newer request
          // supersedes this in-flight mount, the resolved handle is discarded.

          const gen = ++this._previewGen; // Rebuild: release any previous preview first (covers class switching).

          (_this$_previewHandle3 = this._previewHandle) == null || _this$_previewHandle3.destroy();
          this._previewHandle = null;
          const handle = await (_crd && SceneModelPreview === void 0 ? (_reportPossibleCrUseOfSceneModelPreview({
            error: Error()
          }), SceneModelPreview) : SceneModelPreview).instance.showCharacterInSlot(this._modelDisplay, id, 'attack', {
            ownerId: 'CreatePanel',
            forceUnlit: true
        ...
        _onConfirm() {
          ...
          const name = (_this$_editBox$string = (_this$_editBox = this._editBox()) == null ? void 0 : _this$_editBox.string.trim()) != null ? _this$_editBox$string : '';
        ...
        _showError(msg) {
          ...
          const label = (_this$_errorLabel2 = this._errorLabel) == null ? void 0 : _this$_errorLabel2.getComponent(Label);
        ...
        _clearError() {
          ...
          const btn = (_this$_confirmBtn3 = this._confirmBtn) == null ? void 0 : _this$_confirmBtn3.getComponent(Button);
