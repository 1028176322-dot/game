    ...
    execute: function () {
      ...
      _export("EventBus", EventBus = class EventBus {
        ...
        _isValidCallback(event, callback, target) {
          ...
          const owner = (_target$constructor$n = target == null || (_target$constructor = target.constructor) == null ? void 0 : _target$constructor.name) != null ? _target$constructor$n : 'unknown';
