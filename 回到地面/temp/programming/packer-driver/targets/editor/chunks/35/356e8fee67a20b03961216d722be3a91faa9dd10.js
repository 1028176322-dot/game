    ...
    execute: function () {
      ...
      _export("MarqueeUI", MarqueeUI = (_dec = ccclass('MarqueeUI'), _dec2 = property(Prefab), _dec(_class = (_class2 = class MarqueeUI extends Component {
        ...
        _createUI() {
          ...
          const titleLabel = this._createLabelOn('Title', (_crd && T === void 0 ? (_reportPossibleCrUseOfT({
            error: Error()
        ...
        _loadProgress() {
          try {
            const loaded = (_crd && SaveService === void 0 ? (_reportPossibleCrUseOfSaveService({
              error: Error()
