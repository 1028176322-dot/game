    ...
    execute: function () {
      ...
      _export("DungeonSceneInstaller", DungeonSceneInstaller = class DungeonSceneInstaller {
        ...
        install(controllerNode, overrides = {}) {
          ...
          const sceneRoot = (_controllerNode$paren = controllerNode.parent) != null ? _controllerNode$paren : controllerNode;
          const canvas = (_findChildByName = (_crd && F === void 0 ? (_reportPossibleCrUseOfF({
            error: Error()
          }), F) : F).findChildByName(sceneRoot, 'Canvas')) != null ? _findChildByName : sceneRoot;
          const world = (_crd && F === void 0 ? (_reportPossibleCrUseOfF({
            error: Error()
          }), F) : F).ensureChild(canvas, 'World');
          world.setPosition(Vec3.ZERO);
          world.layer = Layers.Enum.UI_2D;
          const systems = (_crd && F === void 0 ? (_reportPossibleCrUseOfF({
            error: Error()
          }), F) : F).ensureChild(canvas, 'Systems');
          const uiRoot = (_crd && F === void 0 ? (_reportPossibleCrUseOfF({
            error: Error()
          ...
          const layerService = (_crd && RuntimeLayerService === void 0 ? (_reportPossibleCrUseOfRuntimeLayerService({
            error: Error()
          }), RuntimeLayerService) : RuntimeLayerService).instance;
          layerService.ensureLayers(world);
          const backgroundLayer = layerService.getLayer((_crd && LayerType === void 0 ? (_reportPossibleCrUseOfLayerType({
            error: Error()
          }), LayerType) : LayerType).Background);
          const tileLayer = layerService.getLayer((_crd && LayerType === void 0 ? (_reportPossibleCrUseOfLayerType({
            error: Error()
          }), LayerType) : LayerType).Tile);
          const actorLayer = layerService.getLayer((_crd && LayerType === void 0 ? (_reportPossibleCrUseOfLayerType({
            error: Error()
          }), LayerType) : LayerType).Actor);
          const effectLayer = layerService.getLayer((_crd && LayerType === void 0 ? (_reportPossibleCrUseOfLayerType({
            error: Error()
          }), LayerType) : LayerType).Effect);
          const doorLayer = layerService.getLayer((_crd && LayerType === void 0 ? (_reportPossibleCrUseOfLayerType({
            error: Error()
          ...
          const gridManager = (_ref = (_overrides$gridManage = overrides.gridManager) != null ? _overrides$gridManage : (_crd && F === void 0 ? (_reportPossibleCrUseOfF({
            error: Error()
          ...
          const playerNode = (_overrides$player$nod = (_overrides$player = overrides.player) == null ? void 0 : _overrides$player.node) != null ? _overrides$player$nod : this._ensureChild(actorLayer, 'Player');
          ...
          const player = (_overrides$player2 = overrides.player) != null ? _overrides$player2 : (_crd && F === void 0 ? (_reportPossibleCrUseOfF({
            error: Error()
          ...
          const bridge = (_crd && F === void 0 ? (_reportPossibleCrUseOfF({
            error: Error()
          ...
          const battleManager = (_ref2 = (_overrides$battleMana = overrides.battleManager) != null ? _overrides$battleMana : (_crd && F === void 0 ? (_reportPossibleCrUseOfF({
            error: Error()
          ...
          const dungeonManager = (_ref3 = (_overrides$dungeonMan = overrides.dungeonManager) != null ? _overrides$dungeonMan : (_crd && F === void 0 ? (_reportPossibleCrUseOfF({
            error: Error()
          ...
          const roomTransition = (_ref4 = (_overrides$roomTransi = overrides.roomTransition) != null ? _overrides$roomTransi : (_crd && F === void 0 ? (_reportPossibleCrUseOfF({
            error: Error()
          ...
          const skillSystem = (_ref5 = (_overrides$skillSyste = overrides.skillSystem) != null ? _overrides$skillSyste : (_crd && F === void 0 ? (_reportPossibleCrUseOfF({
            error: Error()
          ...
          const upgradeManager = (_ref6 = (_overrides$upgradeMan = overrides.upgradeManager) != null ? _overrides$upgradeMan : (_crd && F === void 0 ? (_reportPossibleCrUseOfF({
            error: Error()
          ...
          const elementSystem = (_ref7 = (_overrides$elementSys = overrides.elementSystem) != null ? _overrides$elementSys : (_crd && F === void 0 ? (_reportPossibleCrUseOfF({
            error: Error()
          ...
          const equipmentSystem = (_ref8 = (_overrides$equipmentS = overrides.equipmentSystem) != null ? _overrides$equipmentS : (_crd && F === void 0 ? (_reportPossibleCrUseOfF({
            error: Error()
          ...
          const itemSystem = (_ref9 = (_overrides$itemSystem = overrides.itemSystem) != null ? _overrides$itemSystem : (_crd && F === void 0 ? (_reportPossibleCrUseOfF({
            error: Error()
          ...
          const joystick = (_ref10 = (_overrides$joystick = overrides.joystick) != null ? _overrides$joystick : (_crd && F === void 0 ? (_reportPossibleCrUseOfF({
            error: Error()
          ...
          const battleHUD = (_ref11 = (_overrides$battleHUD = overrides.battleHUD) != null ? _overrides$battleHUD : (_crd && F === void 0 ? (_reportPossibleCrUseOfF({
            error: Error()
          ...
          const dungeonMapUI = (_ref12 = (_overrides$dungeonMap = overrides.dungeonMapUI) != null ? _overrides$dungeonMap : (_crd && F === void 0 ? (_reportPossibleCrUseOfF({
            error: Error()
          ...
          const skillUI = (_findComponentInChild = (_crd && F === void 0 ? (_reportPossibleCrUseOfF({
            error: Error()
          ...
          const upgradeUI = (_ref13 = (_overrides$upgradeUI = overrides.upgradeUI) != null ? _overrides$upgradeUI : (_crd && F === void 0 ? (_reportPossibleCrUseOfF({
            error: Error()
          ...
          const deathUI = (_ref14 = (_overrides$deathUI = overrides.deathUI) != null ? _overrides$deathUI : (_crd && F === void 0 ? (_reportPossibleCrUseOfF({
            error: Error()
          ...
          const equipmentUI = (_ref15 = (_overrides$equipmentU = overrides.equipmentUI) != null ? _overrides$equipmentU : (_crd && F === void 0 ? (_reportPossibleCrUseOfF({
            error: Error()
          ...
          const inventoryUI = (_ref16 = (_overrides$inventoryU = overrides.inventoryUI) != null ? _overrides$inventoryU : (_crd && F === void 0 ? (_reportPossibleCrUseOfF({
            error: Error()
          ...
          const dungeonHUD = (_crd && F === void 0 ? (_reportPossibleCrUseOfF({
            error: Error()
          ...
          const builtLayout = new (_crd && DungeonGenerator === void 0 ? (_reportPossibleCrUseOfDungeonGenerator({
            error: Error()
          }), DungeonGenerator) : DungeonGenerator)().generate(sceneSeed, sceneZone);
          const builtRoom = new (_crd && RoomBuilder === void 0 ? (_reportPossibleCrUseOfRoomBuilder({
            error: Error()
          }), RoomBuilder) : RoomBuilder)().build(builtLayout.rooms[0]);
          const builtNav = new (_crd && NavigationGrid === void 0 ? (_reportPossibleCrUseOfNavigationGrid({
            error: Error()
          }), NavigationGrid) : NavigationGrid)(builtRoom.tileMap);
          const roomRuntime = new (_crd && RoomRuntime === void 0 ? (_reportPossibleCrUseOfRoomRuntime({
            error: Error()
        ...
        async loadInitialArt(refs, characterId = 'warrior', zoneId = 'forest') {
          // Background via semantic key
          const bgKey = `background.bg_combat_${zoneId}`;
          const bgOk = await (_crd && BackgroundService === void 0 ? (_reportPossibleCrUseOfBackgroundService({
            error: Error()
          ...
          if (!bgOk) {
            ...
            await (_crd && RenderAssetService === void 0 ? (_reportPossibleCrUseOfRenderAssetService({
              error: Error()
          ...
          const charOk = await (_crd && CharacterVisualService === void 0 ? (_reportPossibleCrUseOfCharacterVisualService({
            error: Error()
        ...
        _normalizeActorNode(node, parent, name, gridY) {
          ...
          const sortIndex = (_crd && RuntimeLayerService === void 0 ? (_reportPossibleCrUseOfRuntimeLayerService({
            error: Error()
        ...
        _ensureDoor(parent) {
          ...
          const graphics = (_crd && F === void 0 ? (_reportPossibleCrUseOfF({
            error: Error()
        ...
        _ensureJoystick(parent) {
          ...
          const joystick = (_crd && F === void 0 ? (_reportPossibleCrUseOfF({
            error: Error()
        ...
        _ensureBattleHUD(parent) {
          ...
          node.layer = Layers.Enum.UI_2D;
          const hud = (_crd && F === void 0 ? (_reportPossibleCrUseOfF({
            error: Error()
        ...
        _ensureDungeonMapUI(parent) {
          ...
          node.layer = Layers.Enum.UI_2D;
          const map = (_crd && F === void 0 ? (_reportPossibleCrUseOfF({
            error: Error()
        ...
        _reparentToUIRoot(uiRoot, ...nodes) {
        ...
        _ensureLabel(node, text) {
          node.layer = Layers.Enum.UI_2D;
          const label = (_crd && F === void 0 ? (_reportPossibleCrUseOfF({
            error: Error()
