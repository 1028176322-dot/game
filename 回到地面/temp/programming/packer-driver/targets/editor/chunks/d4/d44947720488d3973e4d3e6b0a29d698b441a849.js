  ...
  return {
    ...
    execute: function () {
      ...
      _export("MonsterRuntimeFactory", MonsterRuntimeFactory = class MonsterRuntimeFactory {
        static create(name, prefab = null) {
          ...
          const created = prefab ? null : (_crd && RuntimeEntityFactory === void 0 ? (_reportPossibleCrUseOfRuntimeEntityFactory({
            error: Error()
          ...
          root.name = name;
          const body = (_created$body = created == null ? void 0 : created.body) != null ? _created$body : (_crd && RuntimeEntityFactory === void 0 ? (_reportPossibleCrUseOfRuntimeEntityFactory({
            error: Error()
          }), RuntimeEntityFactory) : RuntimeEntityFactory).ensureSpriteChild(root, 'Body', 96, 96);
          const hpBar = (_created$hpBar = created == null ? void 0 : created.hpBar) != null ? _created$hpBar : (_crd && RuntimeEntityFactory === void 0 ? (_reportPossibleCrUseOfRuntimeEntityFactory({
            error: Error()
          }), RuntimeEntityFactory) : RuntimeEntityFactory).createHPBar(root, 84, 12);
          hpBar.setPosition(0, 58, 0);
          const hpFill = (_ref = (_created$hpFill = created == null ? void 0 : created.hpFill) != null ? _created$hpFill : hpBar.getChildByName('BarFill')) != null ? _ref : undefined;
          const effectSocket = (_created$slots$Effect = created == null ? void 0 : created.slots.EffectSocket) != null ? _created$slots$Effect : (_crd && RuntimeEntityFactory === void 0 ? (_reportPossibleCrUseOfRuntimeEntityFactory({
            error: Error()
          }), RuntimeEntityFactory) : RuntimeEntityFactory).ensureChild(root, 'EffectSocket', 1, 1);
          const shadow = (_created$shadow = created == null ? void 0 : created.shadow) != null ? _created$shadow : (_crd && RuntimeEntityFactory === void 0 ? (_reportPossibleCrUseOfRuntimeEntityFactory({
            error: Error()
          ...
          const view = (_root$getComponent2 = root.getComponent(_crd && MonsterRuntimeView === void 0 ? (_reportPossibleCrUseOfMonsterRuntimeView({
            error: Error()
          ...
          const bodySprite = (_body$getComponent = body.getComponent(Sprite)) != null ? _body$getComponent : body.addComponent(Sprite);
