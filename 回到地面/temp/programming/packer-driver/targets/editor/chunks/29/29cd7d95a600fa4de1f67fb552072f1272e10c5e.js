    ...
    execute: function () {
      ...
      _export("VirtualJoystick", VirtualJoystick = (_dec = ccclass('VirtualJoystick'), _dec2 = property(Node), _dec3 = property(Node), _dec(_class = (_class2 = class VirtualJoystick extends Component {
        ...
        _onTouchStart(touch, event) {
          ...
          const halfW = (_this$node$parent$get = (_this$node$parent = this.node.parent) == null || (_this$node$parent = _this$node$parent.getComponent(UITransform)) == null ? void 0 : _this$node$parent.width) != null ? _this$node$parent$get : 720; // 只处理左半屏触摸
        ...
        _updateFromTouch(touch) {
          ...
          const distance = Math.sqrt(offsetX * offsetX + offsetY * offsetY); // 限制在最大半径内
