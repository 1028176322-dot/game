  ...
  return {
    ...
    execute: function () {
      ...
      _export("NodeRouteState", NodeRouteState = class NodeRouteState {
        ...
        computeReachable(completed = this._state.completedNodeIds) {
        ...
        complete(nodeId) {
          const completed = this._state.completedNodeIds.includes(nodeId) ? this._state.completedNodeIds : [...this._state.completedNodeIds, nodeId];
          this._state = { ...this._state,
