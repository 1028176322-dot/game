    ...
    execute: function () {
      ...
      _export("SplashUI", SplashUI = (_dec = ccclass('SplashUI'), _dec2 = property(Label), _dec3 = property(Node), _dec4 = property(Label), _dec5 = property(Node), _dec(_class = (_class2 = class SplashUI extends Component {
        ...
        _createProgressBar() {
          ...
          var container = (_this$loadingBar = this.loadingBar) != null ? _this$loadingBar : new Node('LoadingBar');
        ...
        _drawBarFill(pct) {
          ...
          var fillW = Math.max(BAR_WIDTH * (pct / 100), 0);
        ...
        start() {
          ...
          var opacity = this.splashImage.getComponent(UIOpacity);
        ...
        _applyBackdropConfig() {
          var _this = this;

          return _asyncToGenerator(function* () {
            var _cfg$transparent;

            if (!_this.splashImage) return; // degrade: keep existing 2D splash
            ...
            _this._backdropHandle = yield (_crd && SceneModelPreview === void 0 ? (_reportPossibleCrUseOfSceneModelPreview({
              error: Error()
            }), SceneModelPreview) : SceneModelPreview).instance.showBackdropInSlot(_this.splashImage, cfg.modelAssetId, {
              ownerId: 'Splash',
