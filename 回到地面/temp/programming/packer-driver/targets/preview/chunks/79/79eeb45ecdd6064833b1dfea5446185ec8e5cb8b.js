  ...
  return {
    ...
    execute: function () {
      ...
      _export("SceneModelPreview", SceneModelPreview = class SceneModelPreview {
        ...
        showCharacterInSlot(slotNode, characterId, action, opts) {
          return _asyncToGenerator(function* () {
            ...
            var ownerId = (_opts$ownerId = opts == null ? void 0 : opts.ownerId) != null ? _opts$ownerId : DEFAULT_OWNER;
            var surface = (_crd && PreviewSurface === void 0 ? (_reportPossibleCrUseOfPreviewSurface({
              error: Error()
            ...
            var fps = (_opts$fps = opts == null ? void 0 : opts.fps) != null ? _opts$fps : DEFAULT_FPS;
            var forceUnlit = (_opts$forceUnlit = opts == null ? void 0 : opts.forceUnlit) != null ? _opts$forceUnlit : true;
            var visualKey = "character." + characterId + "." + action;
            var ok = yield (_crd && CharacterVisualService === void 0 ? (_reportPossibleCrUseOfCharacterVisualService({
              error: Error()
        ...
        showModelInSlot(slotNode, modelAssetId, opts) {
          return _asyncToGenerator(function* () {
            var _opts$ownerId2, _opts$forceUnlit2, _opts$action;

            var ownerId = (_opts$ownerId2 = opts == null ? void 0 : opts.ownerId) != null ? _opts$ownerId2 : DEFAULT_OWNER;
            var surface = (_crd && PreviewSurface === void 0 ? (_reportPossibleCrUseOfPreviewSurface({
              error: Error()
            }), PreviewSurface) : PreviewSurface).instance.acquire(slotNode, {
              width: opts == null ? void 0 : opts.width,
            ...
            var forceUnlit = (_opts$forceUnlit2 = opts == null ? void 0 : opts.forceUnlit) != null ? _opts$forceUnlit2 : true;
            var action = (_opts$action = opts == null ? void 0 : opts.action) != null ? _opts$action : DEFAULT_ACTION;
        ...
        showBackdropInSlot(slotNode, backdropModelAssetId, opts) {
          var _this = this;

          return _asyncToGenerator(function* () {
            if (!backdropModelAssetId) return null; // no-op; keep existing 2D background

            return _this.showModelInSlot(slotNode, backdropModelAssetId, {
        ...
        showBackdrop(backdropModelAssetId, opts) {
          var _this2 = this;
          ...
          return _asyncToGenerator(function* () {
            ...
            var ownerId = (_opts$ownerId3 = opts == null ? void 0 : opts.ownerId) != null ? _opts$ownerId3 : 'MainScene';
            var slotPath = BACKDROP_SLOT_BY_OWNER[ownerId];
            ...
            return _this2.showBackdropInSlot(slotNode, backdropModelAssetId, opts);
          })();
        }
