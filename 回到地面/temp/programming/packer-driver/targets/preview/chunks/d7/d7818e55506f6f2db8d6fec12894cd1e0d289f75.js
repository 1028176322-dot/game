    ...
    execute: function () {
      ...
      _export("CreatePanelLayout", CreatePanelLayout = (_dec = ccclass('CreatePanelLayout'), _dec2 = menu('UI/CreatePanelLayout'), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property(Node), _dec10 = property(Node), _dec11 = property(Node), _dec(_class = _dec2(_class = (_class2 = class CreatePanelLayout extends Component {
        ...
        applyLayout() {
          ...
          var contentSize = (_this$node$getCompone = (_this$node$getCompone2 = this.node.getComponent(UITransform)) == null ? void 0 : _this$node$getCompone2.contentSize) != null ? _this$node$getCompone : new Size(680, 500);
        ...
        _layoutTitle(contentSize) {
          var title = this._node(this.titleLabel, 'HeaderZone/TitleLabel');
        ...
        _layoutPreview(contentSize) {
          var preview = this._node(this.modelDisplay, 'PreviewZone/ModelDisplay');
        ...
        _layoutChoices(contentSize) {
          var cards = this._node(this.cardRoot, 'ChoiceZone/CardRoot');
        ...
        _layoutInfo(contentSize) {
          var info = this._node(this.selectedInfo, 'InfoZone/SelectedInfo');

          var desc = this._node(this.selectedDesc, 'InfoZone/SelectedDesc');
        ...
        _layoutActions(contentSize) {
          ...
          var confirm = this._node(this.confirmBtn, 'ConfirmBtn');

          var skip = this._node(this.skipBtn, 'SkipBtn');

          var error = this._node(this.errorLabel, 'ActionZone/ErrorLabel');
          ...
          var panelRoot = (_this$node$parent = this.node.parent) == null ? void 0 : _this$node$parent.parent; // ContentRoot -> PanelFrame -> PanelRoot

          var panelRootTrans = panelRoot == null ? void 0 : panelRoot.getComponent(UITransform);
          var panelW = (_panelRootTrans$width = panelRootTrans == null ? void 0 : panelRootTrans.width) != null ? _panelRootTrans$width : 1280;
          var panelH = (_panelRootTrans$heigh = panelRootTrans == null ? void 0 : panelRootTrans.height) != null ? _panelRootTrans$heigh : 720;
          var marginX = 24; // margin from left/right panel edge

          var marginY = 20; // margin from bottom panel edge

          var btnHalfW = 100; // 200 / 2

          var btnHalfH = 31; // 62 / 2

          var leftX = -panelW / 2 + marginX + btnHalfW;
          var rightX = panelW / 2 - marginX - btnHalfW;
          var bottomY = -panelH / 2 + marginY + btnHalfH;
        ...
        _layoutNameInput(contentSize) {
          var input = this._node(this.nameInput, 'NameInput');
        ...
        _formatButtonLabel(node, fontSize) {
          var label = node == null ? void 0 : node.getComponentInChildren(Label);
          if (!label) return;
        ...
        _formatLabel(node, fontSize, lineHeight, overflow) {
          ...
          var label = (_node$getComponent = node == null ? void 0 : node.getComponent(Label)) != null ? _node$getComponent : node == null ? void 0 : node.getComponentInChildren(Label);
          if (!label) return;
