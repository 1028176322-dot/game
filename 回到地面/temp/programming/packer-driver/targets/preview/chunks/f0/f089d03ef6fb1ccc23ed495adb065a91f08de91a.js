    ...
    execute: function () {
      ...
      _export("SaveMigrator", SaveMigrator = class SaveMigrator {
        ...
        migrateLegacyPlayerData() {
          var legacyRaw = this._storage.getJson((_crd && LEGACY_KEYS === void 0 ? (_reportPossibleCrUseOfLEGACY_KEYS({
            error: Error()
          ...
          var migrated = migratePlayerDataToV1(legacyRaw.value);
        ...
        loadProfile(defaultValue) {
          ...
          var result = this._storage.readWithMigration((_crd && SAVE_KEYS === void 0 ? (_reportPossibleCrUseOfSAVE_KEYS({
            error: Error()
          ...
          var migrated = this.migrateLegacyPlayerData();
