System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  function validateZoneMonsterRefs(configName, zones, zoneMonsters) {
    for (var zoneId of zones.zonePool) {
      var zone = zones.zones[zoneId];
      ...
      for (var monsterId of zone.monsterPool) {
        var zoneM = zoneMonsters[zoneId];
        ...
        var monsterDef = zoneM[monsterId];
