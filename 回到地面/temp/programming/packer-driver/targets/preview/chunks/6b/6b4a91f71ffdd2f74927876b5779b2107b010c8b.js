    ...
    execute: function () {
      ...
      _export("GameManager", GameManager = (_dec = ccclass('GameManager'), _dec(_class = (_class2 = class GameManager extends Component {
        ...
        get currentStageDef() {
          ...
          var stages = cfg.getStages(this.currentZone);
        ...
        _enterZone(zoneIndex) {
          ...
          var zoneId = this._zoneRoute[zoneIndex];
          var cfg = (_crd && ConfigManager === void 0 ? (_reportPossibleCrUseOfConfigManager({
            error: Error()
          }), ConfigManager) : ConfigManager).getInstance();
        ...
        advanceStage() {
          var zoneId = this.currentZone;
          var cfg = (_crd && ConfigManager === void 0 ? (_reportPossibleCrUseOfConfigManager({
            error: Error()
          }), ConfigManager) : ConfigManager).getInstance();
          var stages = cfg.getStages(zoneId);
        ...
        setPhase(phase) {
          var oldPhase = this._currentPhase;
