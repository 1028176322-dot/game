  ...
  return {
    ...
    execute: function () {
      ...
      _export("RoomFlowController", RoomFlowController = class RoomFlowController {
        ...
        onBattleVictory(mode) {
          if (mode === void 0) {
            mode = 'legacy';
          }

          if (mode === 'route') {
            var ctx = this._routeCtx;
          ...
          var room = this._dungeonManager.currentRoom;
          if (!room) return;
          var roomType = room.type === (_crd && RoomType === void 0 ? (_reportPossibleCrUseOfRoomType({
            error: Error()
        ...
        _handleBossVictory() {
          ...
          var floorState = this._dungeonManager.floorState;
        ...
        onEnterHealingRoom(roomId) {
          if (this._player) {
            ...
            var healAmount = Math.floor(stats.maxHP * 0.2);
