  ...
  return {
    ...
    execute: function () {
      ...
      _export("DungeonSceneController", DungeonSceneController = (_dec = ccclass('DungeonSceneController'), _dec2 = property(_crd && GridManager === void 0 ? (_reportPossibleCrUseOfGridManager({
        ...
        _installSceneRefs() {
          var refs = this._installer.install(this.node, {
        ...
        _bootstrap() {
          ...
          return _asyncToGenerator(function* () {
            ...
            if (_this._booted) return;
            _this._booted = true;

            try {
              yield _this._ensureStartupReady();
            } catch (err) {
            ...
            var rc = (_crd && RunCoordinator === void 0 ? (_reportPossibleCrUseOfRunCoordinator({
              error: Error()
            ...
            if (lighting) {
              var zone = rc.state ? rc.getCurrentZone() : gm.currentZone;
              lighting.apply(zone);
            ...
            if (_this._installedRefs) {
              yield _this._installer.loadInitialArt(_this._installedRefs, (_crd && PlayerDataManager === void 0 ? (_reportPossibleCrUseOfPlayerDataManager({
                error: Error()
              }), PlayerDataManager) : PlayerDataManager).getInstance().selectedCharacter, rc.state ? rc.getCurrentZone() : gm.currentZone);
            }

            yield (_crd && UISkinSceneApplier === void 0 ? (_reportPossibleCrUseOfUISkinSceneApplier({
              error: Error()
            }), UISkinSceneApplier) : UISkinSceneApplier).applyScene((_this$node$scene = _this.node.scene) != null ? _this$node$scene : _this.node, 'dungeon'); // [Phase 10] 打印场景节点树供调试
            ...
            _this._wireEvents(); // [Phase 10] 打印场景节点树供调试
        ...
        _ensureStartupReady() {
          return _asyncToGenerator(function* () {
            ...
            yield (_crd && SpriteAnimationService === void 0 ? (_reportPossibleCrUseOfSpriteAnimationService({
              error: Error()
        ...
        _wireSystems() {
          ...
          var skillSystem = this.skillSystem;
          var autoAttack = (_player$getComponent = player.getComponent(_crd && AutoAttack === void 0 ? (_reportPossibleCrUseOfAutoAttack({
            error: Error()
          ...
          if (this.battleHUD) {
            var initStats = player.stats.getFinalStats();
        ...
        _wireServices() {
          var rs = new (_crd && RewardService === void 0 ? (_reportPossibleCrUseOfRewardService({
            error: Error()
          ...
          var routeRun = new (_crd && RouteRunController === void 0 ? (_reportPossibleCrUseOfRouteRunController({
            error: Error()
        ...
        _wireUI() {
          var es = new (_crd && EventSystem === void 0 ? (_reportPossibleCrUseOfEventSystem({
            error: Error()
          }), EventSystem) : EventSystem)();
          es.init(this.player);

          if (!this._eventUI) {
            var euin = new Node('EventUI');
          ...
          var mm = new (_crd && MutationManager === void 0 ? (_reportPossibleCrUseOfMutationManager({
            error: Error()
        ...
        _wireEvents() {
          ...
          var rf = this._roomFlow;
          var mr = this._mutationRuntime;
          ...
          var zoneDef = (_instance = (_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
            error: Error()
