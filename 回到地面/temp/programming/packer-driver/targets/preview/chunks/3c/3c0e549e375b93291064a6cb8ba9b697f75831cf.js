  ...
  return {
    ...
    execute: function () {
      ...
      _export("AssetCache", AssetCache = class AssetCache {
        constructor(_loader, _releaseDelayMs) {
          if (_releaseDelayMs === void 0) {
            _releaseDelayMs = 1000;
          }
        ...
        load(id) {
          ...
          return _asyncToGenerator(function* () {
            ...
            var existing = _this._entries.get(id);
            ...
            var asset = yield _this._loader(id);

            _this._entries.set(id, {
              asset,
              refs: 1
            });
