    ...
    execute: function () {
      ...
      _export("DeathUI", DeathUI = (_dec = ccclass('DeathUI'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Label), _dec5 = property(Label), _dec6 = property(Label), _dec7 = property(Button), _dec(_class = (_class2 = class DeathUI extends Component {
        ...
        _showSettlement() {
          ...
          var flLabel = (_this$floorLabel = this.floorLabel) == null ? void 0 : _this$floorLabel.getComponent(Label);
          if (flLabel) flLabel.string = (_crd && T === void 0 ? (_reportPossibleCrUseOfT({
            error: Error()
          }), T) : T)('ui.reachFloor', {
            floor: this._deathData.floor
          });
          var klLabel = (_this$killLabel = this.killLabel) == null ? void 0 : _this$killLabel.getComponent(Label);
          if (klLabel) klLabel.string = (_crd && T === void 0 ? (_reportPossibleCrUseOfT({
            error: Error()
          }), T) : T)('ui.defeatCount', {
            count: this._deathData.kills
          });
          var ssLabel = (_this$soulStoneLabel = this.soulStoneLabel) == null ? void 0 : _this$soulStoneLabel.getComponent(Label);
        ...
        onDoubleClick() {
          ...
          (_crd && WXAdapter === void 0 ? (_reportPossibleCrUseOfWXAdapter({
            ...
            if (result.rewarded) {
              ...
              var ssLabel = (_this$soulStoneLabel2 = this.soulStoneLabel) == null ? void 0 : _this$soulStoneLabel2.getComponent(Label);
              if (ssLabel) ssLabel.string = (_crd && T === void 0 ? (_reportPossibleCrUseOfT({
                error: Error()
        ...
        _calcSoulStones(floor) {
          var base = (_crd && GameConfig === void 0 ? (_reportPossibleCrUseOfGameConfig({
            error: Error()
          }), GameConfig) : GameConfig).SOULSTONE_BASE_RATE;
          var perFloor = floor * 8;
          var bossBonus = (_crd && GameConfig === void 0 ? (_reportPossibleCrUseOfGameConfig({
            error: Error()
          }), GameConfig) : GameConfig).SOULSTONE_BOSS_BONUS * floor;
          var stones = base + perFloor + bossBonus; // 魂石波动（0~9 浮动，基于 seed 确定）

          var rewardRng = (_crd && RunRng === void 0 ? (_reportPossibleCrUseOfRunRng({
            error: Error()
