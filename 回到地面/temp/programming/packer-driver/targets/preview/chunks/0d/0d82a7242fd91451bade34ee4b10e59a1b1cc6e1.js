    ...
    execute: function () {
      ...
      _export("RoomTransition", RoomTransition = (_dec = ccclass('RoomTransition'), _dec2 = property(Node), _dec3 = property(Node), _dec(_class = (_class2 = class RoomTransition extends Component {
        ...
        enterRoom(callback) {
          ...
          var opacity = (_this$roomContainer = this.roomContainer) == null ? void 0 : _this$roomContainer.getComponent(UIOpacity);
        ...
        exitRoom(callback) {
          ...
          if (this._isTransitioning) return;
          this._isTransitioning = true;
          var opacity = (_this$roomContainer2 = this.roomContainer) == null ? void 0 : _this$roomContainer2.getComponent(UIOpacity);
