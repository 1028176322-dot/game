    ...
    execute: function () {
      ...
      _export("MonsterController", MonsterController = (_dec = ccclass('MonsterController'), _dec(_class = (_class2 = class MonsterController extends Component {
        ...
        init(config, gridX, gridY, gridManager, battleManager) {
          ...
          var pos = gridManager.gridToWorld(gridX, gridY);
        ...
        takeDamage(rawDamage, isCrit) {
          ...
          var died = (_this$_agent$takeDama = (_this$_agent2 = this._agent) == null ? void 0 : _this$_agent2.takeDamage(rawDamage, isCrit)) != null ? _this$_agent$takeDama : false;
