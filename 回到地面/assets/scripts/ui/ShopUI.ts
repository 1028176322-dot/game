...
export class ShopUI extends Component {
    ...
    private _buildUI(): void {
        ...
        titleLabel.string = T('ui.shopTitle');
    ...
    private _refreshSoulStoneLabel(): void {
        if (this._soulStoneLabel) {
            this._soulStoneLabel.string = T('ui.shopSoulStone', { count: this._dataManager.soulStones });
        }
    }
    ...
    private _createShopItem(
        ...
        if (owned) {
            actionLabel.string = this._dataManager.selectedCharacter === name || this._dataManager.selectedTalent === name ? T('ui.shopActionOwned') : T('ui.shopActionSelect');
            ...
            actionLabel.string = T('ui.shopCost', { cost });
