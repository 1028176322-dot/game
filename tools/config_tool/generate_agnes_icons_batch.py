...
ABILITY_ICONS = [
    ('icon_ability_doublestrike', 'Pixel art game icon 64x64, two crossed swords, golden circle border #D4AF37, dark blue background, fantasy RPG style'),
    ('icon_ability_phasewalk', 'Pixel art game icon 64x64, semi-transparent ghost silhouette passing through stone wall, purple ethereal glow, dark background'),
    ('icon_ability_warcry', 'Pixel art game icon 64x64, warrior face shouting with sound waves radiating outward, red-orange color, dark background'),
    ('icon_ability_lifestealaura', 'Pixel art game icon 64x64, glowing red heart with blood drip and arrow pointing inward, dark background, fantasy game style'),
    ('icon_ability_ricochet', 'Pixel art game icon 64x64, bouncing arrow trajectory hitting two targets, yellow trail, dark blue background'),
    ('icon_ability_shieldreflect', 'Pixel art game icon 64x64, metal shield with arrows bouncing off, silver-gray metallic, dark background'),
    ('icon_ability_bullettime', 'Pixel art game icon 64x64, broken clock with motion blur trails, time slowing effect, purple-blue gradient'),
    ('icon_ability_elementresonance', 'Pixel art game icon 64x64, hexagram symbol surrounded by six colored elemental orbs orbiting, mystical purple, dark background'),
    ('icon_ability_sprint', 'Pixel art game icon 64x64, running human silhouette with speed lines trailing behind, cyan color, dynamic pose'),
    ('icon_ability_frostbite', 'Pixel art game icon 64x64, intricate ice crystal with slow-motion ripple waves emanating, icy blue-white, dark background'),
    ('icon_ability_firewalker', 'Pixel art game icon 64x64, boot print surrounded by roaring flames on dark ground, orange-red fire, dramatic lighting'),
    ('icon_ability_holyshield', 'Pixel art game icon 64x64, ornate golden holy shield with angel wings emblem, divine white-gold glow, dark blue background'),
]
...
RELIC_ICONS = [
    ...
    ('icon_relic_lifelink', 'Pixel art game icon 64x64, chain link connecting two red hearts, blood-red glow, romantic but dark fantasy, dark background'),
...
OUTPUT_DIR_ABILITIES = "assets/resources/textures/icons/abilities"
OUTPUT_DIR_RELICS = "assets/resources/textures/icons/relics"
...
def main():
    all_icons = [
        (ABILITY_ICONS, OUTPUT_DIR_ABILITIES, "能力图标"),
        (RELIC_ICONS, OUTPUT_DIR_RELICS, "遗物图标"),
    ]
    
    total = 0
    failed = 0
    
    for icons_list, output_dir, label in all_icons:
        print(f"\n{'='*50}")
        print(f"生成 {label}: {len(icons_list)} 个文件")
        print(f"{'='*50}")
        
        for filename, prompt in icons_list:
            ...
            try:
                ...
                print(f"  [OK] {filename}.png ({size:,}B)")
                total += 1
